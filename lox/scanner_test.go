    ...
    tests := []test {
        ...
        },
        {
            ...
            expected: []Token{
                ...
                {tokenType: NUMBER, lexeme: "20", literal: "20", line: 1},
                {tokenType: EOF, lexeme: "", literal: "", line: 1},
            },
        },
        {
            ...
            input: "13 / 10",
            expected: []Token{
                {tokenType: NUMBER, lexeme: "13", literal: "13", line: 1},
        ...
        },
        {
            ...
            expected: []Token{
                ...
                {tokenType: NUMBER, lexeme: "1234", literal: "1234", line: 1},
                {tokenType: EOF, lexeme: "", literal: "", line: 1},
            },
        },
        {
        ...
        },
        {
            ...
            expected: []Token{
                ...
                {tokenType: NUMBER, lexeme: "2", literal: "2", line: 1},
                {tokenType: COMMA, lexeme: ",", literal: "", line: 1},
                {tokenType: NUMBER, lexeme: "3", literal: "3", line: 1},
                {tokenType: EOF, lexeme: "", literal: "", line: 1},
            },
        },
        {
        ...
        },
        {
            ...
            expected: []Token{
                ...
                {tokenType: NUMBER, lexeme: "4321", literal: "4321", line: 2},
